# as tax23.R but with centred SV with Koop, Chan, Yu (2024) prior
...
us_fiscal_ex    = ts(us_fiscal_ex[zoo::index(us_fiscal_ex) < 2023.75,], start = c(1948, 1), frequency = 4)
us_fiscal_lsuw  = ts(us_fiscal_lsuw[zoo::index(us_fiscal_lsuw) < 2023.75,], start = c(1948, 1), frequency = 4)
...
save(spec, post, file = paste0("results/tax23_ce.rda"))
